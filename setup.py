...
plugin_identifier = "fusibox"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_fusibox"
...
# module
plugin_description = """Plugin that control the fusibox accesories for 3D printers"""

# The plugin's author. Can be overwritten within OctoPrint's internal data via __plugin_author__ in the plugin module
plugin_author = "Humar Moreno"
...
additional_setup_parameters = {"python_requires": ">=3"}
